...
$apiConfig = array(
    ...
    'oauth2_client_id' => get_option('g_appId'),
    'oauth2_client_secret' => get_option('g_api_secret'),
    'oauth2_redirect_uri' => WPgConnect_Interface::getRedirectUrl(),

    // The developer key, you get this at https://code.google.com/apis/console
    'developer_key' => get_option('g_api_key'),
    ...
    'services' => array(
      ...
      'userprofile' => array('scope' => 'https://www.googleapis.com/auth/userinfo.profile'),
      'useremail' => array('scope' => 'https://www.googleapis.com/auth/userinfo.email')
    )
);