<?php global $theme; ?>
    ...
    <div style="height:190px;width:110px;padding-top:10px;padding-left:15px;padding-right:15px;border:solid 1px #000000;margin-right:10px;float:left;background-color:#9C0356;" <?php post_class('post '); ?> id="post-<?php the_ID(); ?>">
     ...
     <!--   <div class="postmeta-primary">
        ...
        <div class="entry clearfix" style="height:150px;width:100px;">
