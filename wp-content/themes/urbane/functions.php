...
array(
"name" => "Featured Post Category",
"desc" => "Choose the category for your Featured post",
"id" => $shortname."_fcat",
"std" => "featured",
"type" => "text"),

array(
"name" => "Left Post Category",
"desc" => "Choose the category for your Left post",
"id" => $shortname."_lcat",
"std" => "featured",
"type" => "text"),

array(
"name" => "Middle Post Category",
"desc" => "Choose the category for your Middle post",
"id" => $shortname."_mcat",
"std" => "featured",
"type" => "text"),

array(
"name" => "Right Post Category",
"desc" => "Choose the category for your Right post",
"id" => $shortname."_rcat",
"std" => "featured",
"type" => "text"),

array(
"name" => "Feedburner Name (used for 'Subscribe via RSS Feed' section)",
"desc" => "Enter your <a href=\"http://www.feedburner.com\">Feedburner</a> Name (login)",
"id" => $shortname."_feedburner",
"std" => "blogohblog",
"type" => "text"),

array(
"name" => "Feedburner Feed ID (used for 'Subscribe via E-mail' section)",
"desc" => "You can get your Feed ID from your <a href=\"http://www.feedburner.com\">Feedburner</a> account control panel",
...
array(
"name" => "Twitter ID",
"desc" => "Enter your <a href=\"http://www.twitter.com\">Twitter</a> ID",
