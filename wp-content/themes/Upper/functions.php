<?php
    ...
    $theme->options['plugins_options']['featuredposts'] = array('image_sizes' => '470px. x 260px.', 'speed' => '400', 'effect' => 'scrollHorz');
    ...
    $theme->admin_option('Support',
        ...
        <li><strong>Theme Homepage:</strong> <a href="http://fthemes.com/upper-free-wordpress-theme" target="_blank">http://fthemes.com/upper-free-wordpress-theme/</a></li>
    ...
    {
        global $theme;
        $theme->display_widget('SocialShare', array('iconset' => 'icons_4'));
