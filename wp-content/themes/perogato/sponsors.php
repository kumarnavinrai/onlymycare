...
<div class="squarebannerh">
<h3 class="sidetil"> Sponsors </h3>
</div>
...
<li>
<?php 
	$ban1 = get_option('pero_banner1'); 
	$url1 = get_option('pero_url1'); 
?>
...
<li>
<?php 
	$ban2 = get_option('pero_banner2'); 
	$url2 = get_option('pero_url2'); 
	?>
...
<li>
<?php 
	$ban3 = get_option('pero_banner3'); 
	$url3 = get_option('pero_url3'); 
	?>
...
<li>
<?php 
	$ban4 = get_option('pero_banner4'); 
	$url4 = get_option('pero_url4'); 
	?>
