...
<?php global $theme; get_header(); ?>
    ...
    <div id="main">
        ...
        <div id="content">
            ...
            <?php  $i=0; $youMustSeeThis = 0; $numberOfPostsToShowInBox = 52; $lessThanIfPostAreNotEnough = 52;
                if (have_posts()) : while (have_posts()) : the_post();
                     ...
                     */
                    if($i<$numberOfPostsToShowInBox){ 
                    get_template_part('post', 'video');
                    }else{ ?>
                ...
                <div style="margin-bottom:20px;background:none repeat scroll 0 0 #9C0356;color:#ffffff;font-size:17px;font-weight:bold;width:593px;height:25px;padding-top:5px;padding-left:5px;letter-spacing:2px;" >VIDEOS FROM SAME CATEGORY</div>
                 <?php $youMustSeeThis=1;  } ?>
                <?php
                //if posts less than 24 then pic post from parent category starts here
                if($i<$lessThanIfPostAreNotEnough){
					$numberOfPosts = $lessThanIfPostAreNotEnough-$i;
