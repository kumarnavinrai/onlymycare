...
if (isset($fb_user) ){
	$pages = fb_list_user_pages($fb_user);
	if ($pages =="ERROR"){
...
<div>
	...
	<?php 
$onclickcode='onclick="'.$_REQUEST["callback"].'(\'\',\'\',\'\');"';	
echo '<div class="fbconnect_select_top"><input '.$onclickcode.' class="button-primary" type="button" name="select" value="'.__('Clear current selection', 'fbconnect').'" /></div>';
if(isset($pages)){
	echo '<div class="fbconnect_listpages">';
	foreach($pages as $page){
			...
			if (isset($_REQUEST["callback"]) && $_REQUEST["callback"]!=""){
				...
				$onclickcode='onclick="'.$_REQUEST["callback"].'('.$page["page_id"].',\''.$name.'\',\''.$page["page_url"].'\');"';
			}
			echo '<div class="fbconnect_select"><input '.$onclickcode.' class="button-primary" type="button" name="select" value="'.__('Select', 'fbconnect').'" /></div>';
			echo '</div>';
	}
	echo '</div>';
}
