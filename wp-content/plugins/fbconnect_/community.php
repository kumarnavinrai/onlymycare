...
<?php
		...
		if ($pos>=$viewusers){
			echo '<a title="'.__("Community","fbconnect").'" class="'.$addthickbox.'" href="'.fb_get_option('siteurl').'/?fbconnect_action=community&pos='.($pos-$viewusers).'&height=400&width=450">&laquo; '.__('Previous page', 'fbconnect').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</a>';
		}
		if (($pos+$viewusers)<$users_count){
			echo '<a title="'.__("Community","fbconnect").'" class="'.$addthickbox.'" href="'.fb_get_option('siteurl').'/?fbconnect_action=community&pos='.($pos+$viewusers).'&height=400&width=450"> '.__('Next page', 'fbconnect').' &raquo;</a>';
		}
