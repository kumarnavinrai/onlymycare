...
global $wp_version, $fbconnect,$fb_reg_formfields;
			...
			if (isset($_POST['share_update'])){
				...
				update_option( 'fb_add_post_pinterest', isset($_POST['fb_add_post_pinterest']) ? true : false );				
				...
				update_option( 'fb_add_post_head_pinterest', isset($_POST['fb_add_post_head_pinterest']) ? true : false );
				...
				update_option( 'fb_like_show_faces', isset($_POST['fb_like_show_faces']) ? true : false );
				update_option( 'fb_track_events', isset($_POST['fb_track_events']) ? true : false );
			}
			...
			<div class="wrap">
				...
				<form method="post">
	     				...
	     				<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_head_share" id="fb_add_post_head_share" <?php 
									echo fb_get_option('fb_add_post_head_share') ? 'checked="checked"' : ''; ?> />
	     				...
	     				<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_head_like" id="fb_add_post_head_like" <?php 
									echo fb_get_option('fb_add_post_head_like') ? 'checked="checked"' : ''; ?> />
	    				...
	    				<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_head_send" id="fb_add_post_head_send" <?php 
									echo fb_get_option('fb_add_post_head_send') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_head_google1" id="fb_add_post_head_google1" <?php 
									echo fb_get_option('fb_add_post_head_google1') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="tw_add_post_head_share" id="tw_add_post_head_share" <?php 
									echo fb_get_option('tw_add_post_head_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="li_add_post_head_share" id="li_add_post_head_share" <?php 
									echo fb_get_option('li_add_post_head_share') ? 'checked="checked"' : ''; ?> />
									<label for="li_add_post_head_share"><?php _e('Add Linked In share button to post head', 'fbconnect') ?></label>
							</td>
						</tr>
						<tr valign="top">
							<th style="width: 33%" scope="row"><label for="fb_add_post_head_pinterest"><?php _e('Add Pinterest share:', 'fbconnect') ?></label></th>
							<td>
								<p><input type="checkbox" name="fb_add_post_head_pinterest" id="fb_add_post_head_pinterest" <?php 
									echo fb_get_option('fb_add_post_head_pinterest') ? 'checked="checked"' : ''; ?> />
									<label for="fb_add_post_head_pinterest"><?php _e('Add Pinterest share button to post head', 'fbconnect') ?></label>
							</td>
						</tr>
						<tr valign="top">
							<td colspan=2>
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_share" id="fb_add_post_share" <?php 
									echo fb_get_option('fb_add_post_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_like" id="fb_add_post_like" <?php 
									echo fb_get_option('fb_add_post_like') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_send" id="fb_add_post_send" <?php 
									echo fb_get_option('fb_add_post_send') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_like_show_faces" id="fb_like_show_faces" <?php 
									echo fb_get_option('fb_like_show_faces') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_post_google1" id="fb_add_post_google1" <?php 
									echo fb_get_option('fb_add_post_google1') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="tw_add_post_share" id="tw_add_post_share" <?php 
									echo fb_get_option('tw_add_post_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="li_add_post_share" id="li_add_post_share" <?php 
									echo fb_get_option('li_add_post_share') ? 'checked="checked"' : ''; ?> />
									<label for="li_add_post_share"><?php _e('Add Linked In share button to post footer', 'fbconnect') ?></label>
							</td>
						</tr>
						<tr valign="top">
							<th style="width: 33%" scope="row"><label for="fb_add_post_pinterest"><?php _e('Add Pinterest share button:', 'fbconnect') ?></label></th>
							<td>
								<p><input type="checkbox" name="fb_add_post_pinterest" id="fb_add_post_pinterest" <?php 
									echo fb_get_option('fb_add_post_pinterest') ? 'checked="checked"' : ''; ?> />
									<label for="fb_add_post_pinterest"><?php _e('Add Pinterest share button to post footer', 'fbconnect') ?></label>
							</td>
						</tr>
						<tr valign="top">
							<td colspan=2>
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_page_head_share" id="fb_add_page_head_share" <?php 
									echo fb_get_option('fb_add_page_head_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_add_page_share" id="fb_add_page_share" <?php 
									echo fb_get_option('fb_add_page_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_hide_home_head_share" id="fb_hide_home_head_share" <?php 
									echo fb_get_option('fb_hide_home_head_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="checkbox" name="fb_hide_home_share" id="fb_hide_home_share" <?php 
									echo fb_get_option('fb_hide_home_share') ? 'checked="checked"' : ''; ?> />
						...
						<tr valign="top">
							...
							<td>
								<p><input type="text" name="tw_userid" value="<?php echo fb_get_option('tw_userid'); ?>" size="25" /> 
						...
						<tr valign="top">
							...
							<td>
								<p><input type="text" name="fb_share_head_style" value="<?php echo fb_get_option('fb_share_head_style'); ?>" size="50" /> 
						...
						<tr valign="top">
							...
							<td>
								<p><input type="text" name="fb_share_style" value="<?php echo fb_get_option('fb_share_style'); ?>" size="50" /> 
									<label for="fb_share_style"><?php _e('CSS custom styles', 'fbconnect') ?></label>
							</td>
						</tr>
						<tr valign="top">
							<th style="width: 33%" scope="row"><?php _e('Track events with Google Analytics:', 'fbconnect') ?></th>
							<td>
								<p><input type="checkbox" name="fb_track_events" id="fb_track_events" <?php
								if( fb_get_option('fb_track_events') ) echo 'checked="checked"'
								?> />
									<label for="fb_track_events"><?php _e('Before the activation of event tracking, you need to configure Google Analytics on your site.', 'fbconnect') ?></label></p>
