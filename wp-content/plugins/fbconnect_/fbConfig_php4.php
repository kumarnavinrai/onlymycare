...
function fb_feed_publishUserAction($template_data){
	...
	if ($fbclient){		
		$fbapi_client = & $fbclient->api_client;
		$feed_bundle_id = fb_get_option('fb_templates_id');
...
function fb_showFeedDialog(){
		...
		if (isset($template_data) && $template_data!=""){
				...
				echo "window.onload = function() {\n";
					...
					echo "	  FB.Connect.showFeedDialog(".fb_get_option('fb_templates_id').", ".fb_json_encode($template_data).", null, null, FB.FeedStorySize.full , FB.RequireConnect.promptConnect);";
					echo "});\n";
				echo "   };\n";
				//echo "   });\n";
				echo "	</script>";
